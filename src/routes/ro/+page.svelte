...
<main class="main">
  ...
  <div class="keuze-menu" id="keuze-menu">
    <h1>Alegeți una dintre opțiunile de mai jos</h1>
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Vin să descarc și am nevoie de șofer de stivuitor.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Las un pachet și am nevoie de cineva care să semneze pentru el.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Las un pachet și nu am nevoie de nimeni.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Aș dori să vorbesc cu managerul.</button
    >
  </div>

  <div class="get-name-menu" id="get-name-menu">
    <h4>Introduceți numele companiei sau numele personal.</h4>
    <div>
      <input id="bedrijfsnaam-input" placeholder="Nume" bind:value={name} />
      <button on:click={sendNotification}>Următorul</button>
    </div>
  ...
  <div class="status-menu" id="status-menu">
    <div style="display: flex; flex-direction: column; align-items: center;">
      ...
      <h3 style="color: black; display: block;" id="melding1">
        <span>{updatedTime}</span> Trimite o notificare... . Răbdare.
      </h3>

      <h3 style="color: black; display: none" id="melding2">
        <span>{updatedTime}</span> Notificare trimisă. Răbdare.
      </h3>

      <button id="geholpen" on:click={geholpen} style="display: block;"
        >Am primit ajutor sau nu mai am nevoie de ajutor.</button
      >
      ...
      >
        <h3 style="color: black; margin-bottom: 20px">
          <span>{updatedTime}</span> Cineva e pe drum! Răbdare.
        </h3>

        <button on:click={goodbyeScreen}>Click aici dacă ai fost ajutat.</button
        >
      </div>
    </div>
  </div>
  ...
  <div class="afgeef-menu" id="afgeef-menu">
    <div style="display: flex; flex-direction: column; align-items: center;">
      <h4>Vă rugăm să lăsați pachetul aici.</h4>
      <img src="/pakketje.PNG" alt="pakketje" />
      <button on:click={goodbyeScreen}
        >Faceți clic aici după ce ați plasat pachetul.</button
      >
    </div>
  </div>
  ...
  <div class="afscheid-menu" id="afscheid-menu">
    ...
    >
      <h4>Mulțumesc! În numele întregii echipe Esma, o zi bună!</h4>
    </div>
  </div>
</main>
