...
<main class="main">
  <div class="header">
    <a href="/">
      <img src="/icons8-germany-96.png" alt="Germany" />
    </a>
    <a href="/">
      <div class="home">
        <svg
  ...
  <div class="keuze-menu" id="keuze-menu">
    <h1>Wählen Sie eine der folgenden Optionen</h1>
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Ich komme zum Entladen und brauche einen Gabelstaplerfahrer.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Ich bin hier, um etwas abzuholen.</button
    >
    ...
    <button
      ...
      >Ich gebe ein Paket ab und brauche jemanden, der dafür unterschreibt.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Ich gebe ein Paket ab und brauche niemanden.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Ich würde gerne mit dem Manager sprechen.</button
    >
  </div>
  ...
  <div class="status-menu" id="status-menu">
    <div style="display: flex; flex-direction: column; align-items: center;">
      ...
      <h3 style="color: black; display: block;" id="melding1">
        <span>{updatedTime}</span> Benachrichtigung senden... . Geduld.
      </h3>

      <h3 style="color: black; display: none" id="melding2">
        <span>{updatedTime}</span> Benachrichtigung gesendet. Geduld.
      </h3>

      <button id="geholpen" on:click={geholpen} style="display: block;"
        >Ich habe Hilfe erhalten oder benötige keine Hilfe mehr.</button
      >
      ...
      >
        <h3 style="color: black; margin-bottom: 20px">
          <span>{updatedTime}</span> Jemand ist unterwegs! Geduld.
        </h3>

        <button on:click={goodbyeScreen}
          >Klicken Sie hier, wenn Ihnen geholfen wurde.</button
        >
      </div>
    </div>
  </div>
  ...
  <div class="afgeef-menu" id="afgeef-menu">
    <div style="display: flex; flex-direction: column; align-items: center;">
      <h4>Bitte hinterlassen Sie Ihr Paket hier.</h4>
      <img src="/pakketje.PNG" alt="pakketje" />
      <button on:click={goodbyeScreen}
        >Klicken Sie hier, sobald Sie das Paket aufgegeben haben.</button
      >
    </div>
  </div>
  ...
  <div class="afscheid-menu" id="afscheid-menu">
    ...
    >
      <h4>
        Danke schön! Im Namen des gesamten Esma-Teams wünsche ich Ihnen einen
        schönen Tag!
      </h4>
    </div>
  </div>
