...
<main class="main">
  ...
  <div class="keuze-menu" id="keuze-menu">
    <h1>Изберете една от опциите по-долу</h1>
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Идвам да разтоваря и ми трябва шофьор на мотокар.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Тук съм, за да взема нещо.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Оставям пакет и трябва някой да го подпише.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Пускам пакет и не ми трябва никой.</button
    >
  ...
  <div class="status-menu" id="status-menu">
    <div style="display: flex; flex-direction: column; align-items: center;">
      ...
      <h3 style="color: black; display: block;" id="melding1">
        <span>{updatedTime}</span> Изпрати известие... . Търпение.
      </h3>
      ...
      >
        <h3 style="color: black; margin-bottom: 20px">
          <span>{updatedTime}</span> Някой е на път! Търпение.
        </h3>

        <button on:click={goodbyeScreen}
          >Щракнете тук, ако са ви помогнали.</button
        >
      </div>
    </div>
  </div>
  ...
  <div class="afgeef-menu" id="afgeef-menu">
    <div style="display: flex; flex-direction: column; align-items: center;">
      <h4>Моля, оставете пакета си тук.</h4>
      <img src="/pakketje.PNG" alt="pakketje" />
      <button on:click={goodbyeScreen}
        >Щракнете тук, след като поставите пакета.</button
      >
    </div>
  </div>
  ...
  <div class="afscheid-menu" id="afscheid-menu">
    ...
    >
      <h4>Благодаря ти! От името на целия екип на Есма, хубав ден!</h4>
    </div>
  </div>
</main>
