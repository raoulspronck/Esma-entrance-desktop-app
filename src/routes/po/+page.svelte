...
<main class="main">
  ...
  <div class="keuze-menu" id="keuze-menu">
    <h1>Wybierz jedną z poniższych opcji.</h1>
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Przyjadę rozładować i potrzebuję kierowcy wózka widłowego.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Przyszedłem coś odebrać.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Zostawiam paczkę i potrzebuję kogoś, kto ją podpisze.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Zostawiam paczkę i nie potrzebuję nikogo.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Chciałbym porozmawiać z menadżerem.</button
    >
  </div>
  ...
  <div class="status-menu" id="status-menu">
    <div style="display: flex; flex-direction: column; align-items: center;">
      ...
      <h3 style="color: black; display: block;" id="melding1">
        <span>{updatedTime}</span> Wyślij powiadomienie... . Cierpliwość.
      </h3>

      <h3 style="color: black; display: none" id="melding2">
        <span>{updatedTime}</span> Powiadomienie wysłane. Cierpliwość.
      </h3>

      <button id="geholpen" on:click={geholpen} style="display: block;"
        >Otrzymałem pomoc lub już jej nie potrzebuję.</button
      >
      ...
      >
        <h3 style="color: black; margin-bottom: 20px">
          <span>{updatedTime}</span> Ktoś jest w drodze! Cierpliwość.
        </h3>

        <button on:click={goodbyeScreen}
          >Kliknij tutaj, jeśli uzyskałeś pomoc.</button
        >
      </div>
    </div>
  </div>
  ...
  <div class="afgeef-menu" id="afgeef-menu">
    <div style="display: flex; flex-direction: column; align-items: center;">
      <h4>Proszę zostawić tutaj swoją paczkę.</h4>
      <img src="/pakketje.PNG" alt="pakketje" />
      <button on:click={goodbyeScreen}
        >Kliknij tutaj po umieszczeniu paczki.</button
      >
    </div>
  </div>
  ...
  <div class="afscheid-menu" id="afscheid-menu">
    ...
    >
      <h4>Dziękuję! W imieniu całego zespołu Esmy miłego dnia!</h4>
    </div>
  </div>
</main>
