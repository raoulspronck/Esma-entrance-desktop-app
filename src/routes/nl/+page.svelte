...
<main class="main">
  ...
  <div class="keuze-menu" id="keuze-menu">
    <h1>Kies een van onderstaande opties</h1>
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Ik kom lossen en heb een heftruckchauffeur nodig.</button
    >
    ...
    <button
      ...
      >Ik kom een pakketje afgeven en heb iemand nodig om af te tekenen.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>Ik kom een pakketje afgeven en heb niemand nodig.</button
    >
  ...
  <div class="status-menu" id="status-menu">
    <div style="display: flex; flex-direction: column; align-items: center;">
      ...
      <h3 style="color: black; display: block;" id="melding1">
        <span>{updatedTime}</span> Melding versturen... . Even geduld.
      </h3>
      ...
      >
        <h3 style="color: black; margin-bottom: 20px">
          <span>{updatedTime}</span> Er is iemand onderweg! Even geduld.
        </h3>

        <button on:click={goodbyeScreen}>Klik hier als u bent geholpen.</button>
      </div>
    </div>
  </div>
  ...
  <div class="afgeef-menu" id="afgeef-menu">
    <div style="display: flex; flex-direction: column; align-items: center;">
      <h4>Gelieve uw pakketje hier neer te leggen.</h4>
      <img src="/pakketje.PNG" alt="pakketje" />
      <button on:click={goodbyeScreen}
        >Klik hier als u het pakketje heeft neergelegd.</button
      >
    </div>
  </div>
  ...
  <div class="afscheid-menu" id="afscheid-menu">
    <div style="display: flex; flex-direction: column; align-items: center;">
      <h4>Dankje! Namens het gehele Esma team nog een fijne dag gewenst!</h4>
    </div>
  </div>
</main>
