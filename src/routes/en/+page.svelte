...
<main class="main">
  ...
  <div class="keuze-menu" id="keuze-menu">
    <h1>Please, choose one of the options.</h1>
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>I am coming to unload and need a forklift driver.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>I am coming to pick something up.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>I am coming to bring a package and need someone to sign.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>I am coming to bring a package and do NOT need someone to come.</button
    >
    ...
    <button
      on:click={() => {
        ...
        getName();
      }}>I would like to speak to a manager.</button
    >
  </div>

  <div class="get-name-menu" id="get-name-menu">
    <h4>
      Provide us with the name of the company you work for or your personal
      name.
    </h4>
    <div>
  ...
  <div class="status-menu" id="status-menu">
    <div style="display: flex; flex-direction: column; align-items: center;">
      ...
      <h3 style="color: black; display: block;" id="melding1">
        <span>{updatedTime}</span> Sending notification... . Please be patient.
      </h3>

      <h3 style="color: black; display: none" id="melding2">
        <span>{updatedTime}</span> Notification is sent. Please be patient.
      </h3>

      <button id="geholpen" on:click={geholpen} style="display: block;"
        >I received help or I do not need help anymore.</button
      >
      ...
      >
        <h3 style="color: black; margin-bottom: 20px">
          <span>{updatedTime}</span> Someone is on the way! Please be patient.
        </h3>

        <button on:click={goodbyeScreen}
          >Click here if you have been helped.</button
        >
      </div>
    </div>
  </div>
  ...
  <div class="afgeef-menu" id="afgeef-menu">
    <div style="display: flex; flex-direction: column; align-items: center;">
      <h4>Please put down your package here.</h4>
      <img src="/pakketje.PNG" alt="pakketje" />
      <button on:click={goodbyeScreen}
        >Click here if you have put down your package.</button
      >
    </div>
  </div>
  ...
  <div class="afscheid-menu" id="afscheid-menu">
    ...
    >
      <h4>
        Thank you very much! Wishing a very nice day on behalf of the entire
        Esma team!
      </h4>
    </div>
  </div>
